                    ...
                    <td style="{{ $style['email-body'] }}" width="100%">
                        <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0"
                            ...
                            <tr>
                                ...
                                <!-- Salutation -->
                                    <p style="{{ $style['paragraph'] }}">
                                        {{trans('authist::email.salutation')}},<br>{{ config('app.name') }}
                                    </p>
                                            ...
                                            <tr>
                                                <td style="{{ $fontFamily }}">
                                                    <p style="{{ $style['paragraph-sub'] }}">
                                                        {{trans('authist::email.link_notice', compact('actionText'))}}:
                                                    </p>
                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                    <p style="{{ $style['paragraph-sub'] }}">
                                        ...
                                        {{trans('authist::email.right_reserved')}}.
                                        <br>
                                        <a rel="license" href="https://creativecommons.org/licenses/by-nc-sa/4.0/">
                                            <img alt="Lisensi Creative Commons" style="border-width:0"
